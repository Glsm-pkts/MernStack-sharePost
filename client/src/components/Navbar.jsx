...
dispatch({type: "MODAL", payload: true})
  ...
  return (
    <div className='h-20 bg-gray-700 flex items-center justify-between px-5'>
    ...
    <div className='flex items-center space-x-5'>
      ...
      <div onClick={openModal} className='w-36 border p-2 rounded-md text-center text-white cursor-pointer hover:bg-gray-80 '>Post Oluştur</div>
